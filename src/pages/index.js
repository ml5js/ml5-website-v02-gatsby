  ...
  return (
    ...
    <Layout>
      ...
      <section aria-label="Introduction to ml5.js">
        ...
        />
        <Spacer />
        <h2>What you can do with ml5.js?</h2>
        <div style={styles.flexContainer}>
          <ProjectBox title="BodyPose" description="Description" />
          <ProjectBox title="HandPose" description="Description" />
          <ProjectBox title="FaceMesh" description="Description" />
          <ProjectBox title="Image Classifier" description="Description" />
          <ProjectBox title="Sound Classifier" description="Description" />
          <ProjectBox title="ml5.js Neural Network" description="Description" />
        </div>
        <Spacer height="3rem" />
      </section>

      <section aria-label="Featured Projects">
        <h2>Discover the creative possibilities of machine learning!</h2>
        <p>Coming soon!</p>
        {/* <div style={styles.flexContainer}>
          {posts.map((post) => (
            // <div key={post.id}></div>
